...
class _KidState extends State<nextOfKin> {
        ...
        child: AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              ...
              onPressed: () {
                if(controllerName.text != "" && controllerAddress != ""){
                  globals.nextOfKinModel = NextOfKin(name: controllerName.text, address: controllerAddress.text);
                  globals.controllerNextKin.text = controllerName.text+", "+controllerAddress.text;
