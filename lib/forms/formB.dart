...
import 'kid_info.dart';
import 'dart:io';

class FormB extends StatefulWidget {
  final VoidCallback onfrontPress,onbackPress;
  const FormB({Key? key,required this.onfrontPress,required this.onbackPress}) : super(key: key);

  @override
  _FamilyFormState createState() => _FamilyFormState();
}

class _FamilyFormState extends State<FormB> {
                      ...
                      Padding(
                        ...
                        child: SelectFormField(
                          ...
                          onChanged: (String current) {
                            setState(() {
                              current == "Yes"
                                  ? this._familyMamber = true
                                  : this._familyMamber = false;
