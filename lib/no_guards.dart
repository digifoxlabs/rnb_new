...
import 'blocs/card_labour_active.dart';
 class NoOfGuards extends StatefulWidget {
   const NoOfGuards({Key? key}) : super(key: key);

   @override
   _NoOfGuardsState createState() => _NoOfGuardsState();
 }
bool _isLoading = false;
Widget container = new Container(child: Text(""),);
 class _NoOfGuardsState extends State<NoOfGuards> {
   @override
   ...
   getData() async {
     ...
     var response = await get(Uri.parse("https://rnb.digifoxlabs.com/api/employee/view?role=security"),
