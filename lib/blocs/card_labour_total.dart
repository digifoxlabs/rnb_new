...
class CardLabourTotal extends StatefulWidget {

  GetFormModel formModel;
  CardLabourTotal(@required this.formModel) :assert(formModel != null);

  @override
  _CardLabourTotalState createState() => _CardLabourTotalState();
}

class _CardLabourTotalState extends State<CardLabourTotal> {
  @override
        ...
        child: Container(
          ...
          child: InkWell(
            ...
            onTap: (){
              Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Profile(widget.formModel)));
            },
            child: Padding(
